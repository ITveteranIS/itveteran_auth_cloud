package com.sga.securit.config.swaggerconfigs;
...
@EnableKnife4j
public class SwaggerBootstrapConfigs {
    @Bean
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sga.controller"))
